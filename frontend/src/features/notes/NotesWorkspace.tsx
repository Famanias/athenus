  ...
  return (
    <div className="flex h-full w-full overflow-hidden bg-background">
      ...
      <main className="flex-1 flex flex-col h-full min-w-0 overflow-hidden relative">
        {/* Top App / Note Toolbar with centered max-width and comfortable side padding */}
        <div className="w-full shrink-0 border-b border-outline-variant/30 bg-background/50 backdrop-blur-xs">
          <div className="max-w-4xl mx-auto w-full px-8 md:px-12 py-4">
            <NoteTopToolbar
              title={noteTitle}
        ...
        {/* Dynamic View Canvas Body with centered max-width and generous side padding */}
        <div className="flex-1 overflow-y-auto custom-scrollbar pb-32">
          <div className="max-w-4xl mx-auto w-full px-8 md:px-12 py-6 space-y-6">
            {/* Completion Toast Banner */}
            {toastMessage && (
              <div className="px-4 py-2 bg-emerald-500/10 border border-emerald-500/30 rounded-lg text-emerald-400 font-mono text-xs font-semibold animate-pulse flex items-center justify-between shrink-0">
        ...
        {/* Floating Bottom AI Action Bar centered with matching width */}
