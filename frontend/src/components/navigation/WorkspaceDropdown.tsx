  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 bg-surface-container-high hover:bg-surface-container px-3 py-1.5 rounded border border-outline-variant transition-colors cursor-pointer text-left"
      >
        ...
        <div className="absolute left-0 top-full mt-2 w-72 max-w-[calc(100vw-1rem)] bg-surface-container-high border border-outline-variant rounded-lg shadow-2xl z-50 overflow-hidden flex flex-col">
          ...
          <div className="p-2 border-b border-outline-variant bg-surface-container-low">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-surface-container border border-outline-variant rounded pl-8 pr-3 py-1 text-xs text-on-surface placeholder:text-on-surface-variant/50 focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="p-2 border-t border-outline-variant bg-surface-container-low flex justify-between items-center">
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 text-xs text-secondary hover:text-on-surface font-mono py-1 rounded hover:bg-surface-container transition-colors"
            >
